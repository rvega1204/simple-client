        ...
        <Layout>
            <Row className="justify-content-center">
                <Col md={6}>
                    ...
                    <ul>
                        <li><strong>Frontend Development</strong>: Building a dynamic and responsive client-side interface with React.</li>
                        <li><strong>Backend Development</strong>: Creating APIs and handling server-side logic using Node.js and Express.js.</li>
                        <li><strong>Full-Stack Integration</strong>: Connecting the frontend and backend for a seamless user experience.</li>
                    </ul>
